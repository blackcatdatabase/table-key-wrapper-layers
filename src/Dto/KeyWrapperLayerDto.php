...
namespace BlackCat\Database\Packages\KeyWrapperLayers\Dto;
 ...
 */
final class KeyWrapperLayerDto implements \JsonSerializable {
    public function __construct(
        public readonly int $id,
        public readonly int $keyWrapperId,
        public readonly int $layerNo,
        public readonly ?int $kmsKeyId,
        public readonly int $kemAlgoId,
        public readonly string $kemCiphertext,
        public readonly ?string $encapPubkey,
        public readonly array|null $aad,
