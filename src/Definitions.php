...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'key_wrapper_layers'; }
    public static function contractView(): string { return 'vw_key_wrapper_layers'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'key_wrapper_id', 'layer_no', 'kms_key_id', 'kem_algo_id', 'kem_ciphertext', 'encap_pubkey', 'aad', 'meta', 'created_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'key_wrapper_id', 'layer_no' ], [ 'id' ] ]; }

    /** @return string[] JSON columns for casts/operations */
    public static function jsonColumns(): array { return [ 'aad', 'meta' ]; }

    /** @return string[] List of numeric columns (generator heuristic; no runtime DB queries). */
    public static function intColumns(): array { return [ 'id', 'key_wrapper_id', 'layer_no', 'kms_key_id', 'kem_algo_id' ]; }
