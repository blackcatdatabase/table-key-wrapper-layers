...
final class KeyWrapperLayersModule implements ModuleInterface
{
    public function name(): string { return 'table-key_wrapper_layers'; }
    public function table(): string { return 'key_wrapper_layers'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-crypto_algorithms', 'table-key_wrappers', 'table-kms_keys' ]; }
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_kwl_algo', 'idx_kwl_kw' ];
        $expectedFk  = [ 'fk_kwl_algo', 'fk_kwl_kms', 'fk_kwl_kw' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_kwl_algo', 'idx_kwl_kw' ],
            'foreignKeys' => [ 'fk_kwl_algo', 'fk_kwl_kms', 'fk_kwl_kw' ],
        ];
    }
}
