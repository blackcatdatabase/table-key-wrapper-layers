...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'key_wrapper_id', 'layer_no', 'kms_key_id', 'kem_algo_id', 'kem_ciphertext', 'encap_pubkey', 'aad', 'meta', 'created_at' ];
    }
    ...
    {
        return [ 'id', 'key_wrapper_id', 'layer_no', 'kms_key_id', 'kem_algo_id', 'created_at' ];
    }
    ...
    protected function joinable(): array
    {
        ...
        return [ 'key_wrappers' => 'j0', 'kms_keys' => 'j1', 'crypto_algorithms' => 'j2' ];
    }
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\KeyWrapperLayers\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\KeyWrapperLayers\Definitions::softDeleteColumn();
