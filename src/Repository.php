...
namespace BlackCat\Database\Packages\KeyWrapperLayers;
...
use BlackCat\Database\Packages\KeyWrapperLayers\Repository\KeyWrapperLayerRepository as GeneratedRepository;
...
{
  private KeyWrapperLayerRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof KeyWrapperLayerRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected KeyWrapperLayerRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\KeyWrapperLayers\Dto\KeyWrapperLayerDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\KeyWrapperLayers\Dto\KeyWrapperLayerDto|null { return $this->repo->getById($id, $asDto); }
