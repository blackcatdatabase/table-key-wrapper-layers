...
use BlackCat\Database\Packages\KeyWrapperLayers\Repository\KeyWrapperLayerRepository;
...
{
    private KeyWrapperLayerRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new KeyWrapperLayerRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\KeyWrapperLayers\Dto\KeyWrapperLayerDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\KeyWrapperLayers\Dto\KeyWrapperLayerDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\KeyWrapperLayers\Dto\KeyWrapperLayerDto|null
    {
