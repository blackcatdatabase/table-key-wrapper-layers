...
namespace BlackCat\Database\Packages\KeyWrapperLayers\Mapper;

use BlackCat\Database\Packages\KeyWrapperLayers\Dto\KeyWrapperLayerDto;
use BlackCat\Database\Packages\KeyWrapperLayers\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO KeyWrapperLayerDto:
...
final class KeyWrapperLayerDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'key_wrapper_id', 'layer_no', 'kms_key_id', 'kem_algo_id' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [ 'aad', 'meta' ];
    /** @var string[] */
    private const DATE_COLS   = [ 'created_at' ];
    /** @var string[] */
    private const BIN_COLS    = [ 'kem_ciphertext', 'encap_pubkey' ];
     ...
     * @return KeyWrapperLayerDto
     */
    public static function fromRow(array $row): KeyWrapperLayerDto
    {
        /** @var KeyWrapperLayerDto */
        return DtoHydrator::fromRow(
            KeyWrapperLayerDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?KeyWrapperLayerDto
    {
     ...
     *
     * @param KeyWrapperLayerDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(KeyWrapperLayerDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(KeyWrapperLayerDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(KeyWrapperLayerDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,KeyWrapperLayerDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,KeyWrapperLayerDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(KeyWrapperLayerDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,KeyWrapperLayerDto>
     */
