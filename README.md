...
> Lineage: 3 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 5 · Changelog: fresh (2 d)
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package key-wrapper-layers -Apply
