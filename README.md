...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 3 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII: 5 · Changelog: fresh (2 d)</div>
</div>
...
- Pkg folder: [packages\key-wrapper-layers](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\key-wrapper-layers)
...
- Outbound (depends on): "crypto_algorithms", "key_wrappers", "kms_keys"
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package key-wrapper-layers -Apply
